...
protected:
    ...
    // 索引0/1/2对应一号/二号/三号夹爪
    float claw_close_angle[3] = {125.0f, 130.0f, 130.0f}; // 夹爪闭合角度
    float claw_open_angle[3] = {80.0f, 80.0f, 80.0f}; // 夹爪张开角度s
